...
public class TomarFoto extends AppCompatActivity {
    ...
    ImageButton ok;
    TextView tv;
    static String databasename = "proof.db";
    ...
    public void tomarFoto(View v) throws Exception {
        Thread two = new Thread() {
            @Override
            public void run() {
                File carpetaIMG = new File(Environment.getExternalStorageDirectory() + "/DCIM/proof/", "img");
                if ((raiz.equals("1")) || (raiz.equals("2")) || (raiz.equals("3"))) {
                    ...
                    path = Environment.getExternalStorageDirectory() + "/DCIM/proof/img/" + nombreFoto;
