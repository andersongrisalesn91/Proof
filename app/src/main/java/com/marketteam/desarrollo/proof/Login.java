...
import com.marketteam.desarrollo.proof.R;
...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConsultaGeneral cons = new ConsultaGeneral(getBaseContext(),"proof.db");
    ...
    protected void onStart() {
        ...
        cGeneral = new ConsultaGeneral(getBaseContext(),"proof.db");
        operaciones = new OperacionesBDInterna(getBaseContext(),"proof.db");
        fg = new FuncionesGenerales(getBaseContext(),"proof.db");
    ...
    public void Login(View vista) throws Exception {
        ...
        ConsultaGeneral query = new ConsultaGeneral(getBaseContext(),"proof.db");
    ...
    public void logeoOnline() {
        OperacionesBDInterna opers = new OperacionesBDInterna(getBaseContext(),"proof.db");
            if (existe) {
    ...
    public void RestaurarDB(View v) {
        ...
        operaciones = new OperacionesBDInterna(getBaseContext(),"proof.db");
        conGen = new ConsultaGeneral(getBaseContext(),"proof.db");
